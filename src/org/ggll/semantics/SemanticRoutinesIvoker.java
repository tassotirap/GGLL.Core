...
public class SemanticRoutinesIvoker implements Cloneable, TokenListener
{
	...
	public static final String DEFAULT_SR_CLASS = "org.ggll.semantics.SemanticRoutines";
	...
	public static SemanticRoutinesIvoker getLastInstance(SemanticRoutinesRepo repository, ParseStack parseStack)
	{
